...
> **Note (Phase 6):** the Model Board now displays as a "demo snapshot"
> with the H1 reading "Sample Slate" while the site is in demo mode.
> Capture screenshots of this framing — it's the honest version. The
> "Sample Slate" framing replaces the previous date-based H1 ("Thursday,
> April 30").
