    ...
    <div className="mx-auto max-w-[1280px] px-6 py-12 md:py-20">
      ...
      <section className="reveal">
        <div className="eyebrow mb-5 flex items-center gap-2">
          ...
          {meta.isDemo ? "demo snapshot · sample slate" : `model board live · ${formatDateLong(board.generatedFor)}`}
        </div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          >
            {meta.isDemo ? "View the demo board" : "View today's board"}
      ...
      <section className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-3">
        <KpiTile
          label={meta.isDemo ? "leans in snapshot" : "leans today"}
          value={String(leansToday)}
          delay={1}
        />
        <KpiTile
          label={meta.isDemo ? "high-conf in snapshot" : "high confidence"}
        ...
        <KpiTile
          ...
          sub={meta.isDemo ? "demo data" : `across ${hitRates.overall.total} leans`}
          delay={3}
        />
        <KpiTile
