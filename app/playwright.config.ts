...
export default defineConfig({
  ...
  projects: [
    ...
    // running them 3x would triple the suite for no added signal.
    {
      ...
      testMatch: /accessibility\.spec\.ts|route-assurance\.spec\.ts|p185-color-mix\.spec\.ts|p185-motion-roles\.spec\.ts|p202-journey-matrix\.spec\.ts|p214-scene-matrix\.spec\.ts/,
    },
    {
      name: "firefox-a11y",
