...
export default function ParlayLabPage() {
  ...
  for (const date of allDates) {
    ...
    // Compute the day label from the live `buildTimeToday` rather than
    // `slate.days[].dayLabel`. The slate file is regenerated by the
    // pipeline and can carry yesterday's "Today" / "Tomorrow" strings
    // when the static export ships before the next morning refresh;
    // dayLabelFor() keeps the label honest to the current ET day.
    const baseLabel = dayLabelFor(date, buildTimeToday);
