        ...
        {schedule.games.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
            {schedule.games.map((g) => (
              <div key={g.gamePk ?? `${g.awayTeamAbbr}-${g.homeTeamAbbr}`} className="flex items-center justify-between gap-3 rounded-[3px]" style={{ paddingTop: 10, paddingBottom: 10, paddingLeft: 14, paddingRight: 14, border: "1px solid var(--vault-border)", background: "rgba(7, 11, 26, 0.45)", minWidth: 0, overflow: "hidden" }}>
