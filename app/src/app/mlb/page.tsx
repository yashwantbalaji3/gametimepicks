...
export default function MlbLandingPage() {
        ...
        {games.map((g) => {
          ...
          return (
            <Link
              ...
              style={{ padding: "12px 14px", border: "1px solid var(--vault-border)", background: "color-mix(in srgb, var(--vault-scrim-base) 55%, transparent)", color: "inherit", textDecoration: "none" }}
  ...
  const resultsTab = (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3 flex-wrap rounded-[8px] px-4 py-3" style={{ background: "color-mix(in srgb, var(--vault-scrim-base) 55%, transparent)", border: "1px solid var(--vault-border)" }}>
