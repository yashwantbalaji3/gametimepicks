...
export default function NhlLandingPage() {
  ...
  return (
    <div className="vault-page-shell px-4 sm:px-8 py-8 sm:py-14 overflow-x-hidden">
      ...
      {/* Unified sport-lobby action grid — every sport ships the same
          four tiles so users can find Board / Parlays / Power / Results
          in the same place. */}
      <div className="mt-8">
        <SportLobbyActions
          sport="nhl"
          status={{
            board: { text: "lines pending", tone: "warn" },
            parlays: {
              text: "pending model board",
              tone: "mute",
            },
