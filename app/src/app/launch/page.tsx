  ...
  const gatePackets = buildGatePackets({
    ...
    moonshotState: (() => {
      try {
        ...
        /* P250 · A01: SAME LOADERS as /moonshot (history union + today's published-card count) —
           latest.json alone rotates applied settlements into bare holds, so this console reported
