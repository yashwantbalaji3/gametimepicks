  ...
  return (
    <div className="vault-page-shell px-4 sm:px-8 py-8 sm:py-14 overflow-x-hidden">
      ...
      <SportOverviewHero
        ...
        statusKind="upcoming"
        statusLabel={
          daysOut > 0 ? `${daysOut} days to kickoff` : "Tournament live"
        }
        statusCaption=" · projections coming soon"
        matchupLine={
          opener
        ...
        framing="Official schedule + groups from the FIFA Final Draw. Projections, parlays, and odds are NOT live yet — they unlock once the model ingests team form, lineups, market context, and travel/rest. Squads publish on June 2, 2026; we refuse to print player names before each federation officially releases its 26-man roster."
        accent="gold"
      />
      ...
      <OverviewFooterDisclosure
        ...
        framingBody={
          <>
            ...
            absent for World Cup matches today. Final squads publish June 2 —
            no player names appear here until each federation officially
            announces its 26-player roster. We refuse to invent rosters,
            results, or "model edge" before the model is live.
          </>
        }
      />
    </div>
