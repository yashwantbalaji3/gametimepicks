 ...
 *
 * Public users see: schedule status, model leans status, updated time,
 * and an "educational analytics only" tag. Provider names, API credits,
 * fallback toggles, and internal verification labels are NEVER rendered to public
 * users.
 *
 * Operator details render only when NEXT_PUBLIC_SHOW_DIAGNOSTICS=true,
