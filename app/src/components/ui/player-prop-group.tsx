...
export default function PlayerPropGroup({ group, defaultOpen }: { group: ReturnType<typeof groupByPlayer>[number]; defaultOpen?: boolean }) {
  ...
  return (
    <details className="gtp-card-hover rounded-[9px] min-w-0 group" open={defaultOpen} style={{ background: "color-mix(in srgb, var(--vault-scrim-base) 55%, transparent)", border: "1px solid var(--vault-border)" }}>
