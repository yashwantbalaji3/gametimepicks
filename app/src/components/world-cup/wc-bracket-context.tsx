...
function Node({ title, line, sub, tone = "text" }: { title: string; line: string; sub?: string; tone?: "text" | "gold" | "faint" }) {
  ...
  return (
    <div className="rounded-[10px] px-3 py-2.5 flex flex-col gap-0.5" style={{ background: "color-mix(in srgb, var(--vault-scrim-base) 50%, transparent)", border: "1px solid var(--vault-border)" }}>
