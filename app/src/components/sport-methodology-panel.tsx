...
const METHODOLOGY: Record<Sport, { title: string; kind: string; lines: string[] }> = {
  ...
  nfl: {
    ...
    lines: [
      ...
      "Receptions, receiving yards and anytime touchdown carry validated model numbers. Passing and rushing yards publish as estimates, with the evaluation bar each one missed stated beside it. Availability travels with every player row.",
    ],
  },
  mlb: {
