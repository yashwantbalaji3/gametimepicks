...
export default function MrDubTodayCard() {
  ...
  return (
    <Link href="/mr-dub" className="gtp-card-hover flex flex-wrap items-center gap-3 rounded-2xl px-4 py-3.5" style={{ border: "1px solid var(--vault-border)", borderTop: "2px solid var(--vault-gold-bright)", background: "linear-gradient(135deg, color-mix(in srgb, var(--vault-crown) 8%, transparent), color-mix(in srgb, var(--vault-scrim-base) 30%, transparent))", textDecoration: "none" }}>
      <MrDubAvatar size={40} />
