...
import { pct, Section, StatTile, Monogram, AdvancedDisclosure } from "@/components/game/report-v2-shell";
...
export default function SoccerSimulationReportV2(props: SoccerSimulationReportV2Props) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {advanced ? <AdvancedDisclosure label="Full market detail &amp; advanced report">{advanced}</AdvancedDisclosure> : null}
    </div>
  );
}
