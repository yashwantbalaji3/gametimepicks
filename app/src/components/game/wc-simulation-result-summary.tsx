      ...
      {tw ? (
        <div className="flex flex-col gap-1.5">
          <div className="flex h-7 w-full overflow-hidden rounded-[6px]" style={{ border: "1px solid var(--vault-border)" }}>
            <div style={{ width: `${tw.home * 100}%`, background: "rgba(242,54,69,0.55)" }} className="flex items-center justify-center" title={`${home} ${pct(tw.home)}`}><span className="font-mono" style={{ fontSize: 9.5, color: "#fff", fontWeight: 700 }}>{pct(tw.home)}</span></div>
