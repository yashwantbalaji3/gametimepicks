...
const _GRADE_TONE: Record<CustomParlayGrade["grade"], { fg: string; bg: string; border: string }> = {
  ...
  B: { fg: "var(--vault-gold-bright)", bg: "var(--vault-gold-dim)", border: "color-mix(in srgb, var(--vault-accent) 40%, transparent)" },
  ...
  F: { fg: "var(--vault-danger)", bg: "var(--vault-danger-dim)", border: "color-mix(in srgb, var(--vault-danger-soft) 45%, transparent)" },
};
