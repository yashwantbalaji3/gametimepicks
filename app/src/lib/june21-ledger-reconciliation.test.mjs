...
//     - July-7 settlement: Lane A won its cycle-8 Step-2 (rolls, no seed lost → +1 win, advanced to Step 3)
//   => currentBankroll $19,065.40, drawdown $1400, record 19-14-0-0; $0 open exposure (settled rungs released).
