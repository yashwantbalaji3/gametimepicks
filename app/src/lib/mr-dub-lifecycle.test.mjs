...
test("Mr. Dub ledger after the 2nd ladder is BANKED: crown $20,465.40, bankroll $19,065.40, exposure $0, record 17-14-0-0", () => {
  ...
  assert.deepEqual(p.record, { wins: 17, losses: 14, voids: 0, pending: 0 }, "17-14-0-0 after July-5 (both lanes lost)");
