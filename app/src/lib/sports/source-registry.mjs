...
export const SOURCES = Object.freeze({
  ...
  api_football: {
    owner: "AUTOMATION",
    cost: "free tier (historical WC usage)",
    credentials: "API_FOOTBALL_KEY (CI secret)",
    terms: "api-sports licence; WC player portraits already rendered publicly via media.api-sports.io (allowlisted host)",
    authorization: "PUBLIC_DISPLAY",
    sports: ["world_cup", "epl"],
    roles: ["identity-assets", "schedule-candidate"],
    failureBehavior: "rate-limited free tier; adapters must treat empty responses as SOURCE_STALE, never as an empty slate",
  },
  balldontlie: {
    owner: "AUTOMATION",
    cost: "free tier",
