...
export const SOURCES = Object.freeze({
  ...
  espn_site_api_nfl: {
    ...
    cost: "free",
    credentials: "none",
    terms: "site.api.espn.com public team/roster/summary JSON, no key — the SAME usage class as espn_scoreboard (point-in-time snapshots with attribution, facts not prose). Split into its own entry because Program 169 assigns it roles with different freshness/consumer rules than schedules",
    authorization: "PUBLIC_DISPLAY",
    sports: ["nfl"],
  ...
  nfl_weather_unsourced: {
    ...
    cost: "n/a",
    credentials: "none",
    terms: "NO authorized weather/venue-conditions source exists in this repository. Recorded so no adapter can quietly assume one — weather-dependent features stay UNKNOWN and models that would need them must widen or abstain (Program 169 fail-closed rule)",
    authorization: "BLOCKED",
    sports: ["nfl"],
    roles: ["weather-venue"],
    failureBehavior: "the role itself is the gap: consumers receive UNSOURCED, never a default of 'clear/indoor'",
  },
  openfootball: {
    owner: "AUTOMATION",
    cost: "free",
