...
export const ROUTE_TABLE = Object.freeze({
  ...
  "/epl": { classification: "public", owner: "product", purpose: "Premier League SCHEDULE hub (P186): fixtures grouped by ET day with club crests — states 'Schedule only — simulation pending' and publishes nothing predictive", dataOwner: "openfootball schedule capture (build-time read)", freshness: "capture stamp in copy" },
