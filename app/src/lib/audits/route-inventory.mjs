...
export const ROUTE_TABLE = Object.freeze({
  ...
  "/my": { classification: "public", indexable: false, owner: "product", purpose: "My GameTime (v1.1.3) — live games, upcoming matchups, saved forecasts, results and followed players for what THIS device follows. A view over existing owners, never a truth owner; noindex because a crawler has no follows", dataOwner: "build-time public read model (schedules, canonical results) + /data/my/nfl-players.json + the Follow and Saved stores + the /live batch slate", freshness: "per module: live on the reader clock; schedules/results per artifact" },
