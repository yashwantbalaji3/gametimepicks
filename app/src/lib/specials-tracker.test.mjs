...
test("World Cup Specials are SEPARATE from core / moonshot / crown (no blending)", () => {
  ...
  assert.deepEqual(portfolio.record, { wins: 17, losses: 10, voids: 0, pending: 0 }, "core record reflects only the BB settlement, not specials (July-2: Lane A won its Step 2, Lane B stopped)");
