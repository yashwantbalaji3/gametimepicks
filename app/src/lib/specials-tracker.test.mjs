...
test("World Cup Specials are SEPARATE from core / moonshot / crown (no blending)", () => {
  ...
  assert.deepEqual(portfolio.record, { wins: 15, losses: 5, voids: 0, pending: 0 }, "core record reflects only the BB settlement, not specials (June-26: Lane A Step-2 lost, Lane B Step-1 won)");
