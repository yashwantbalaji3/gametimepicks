...
test("World Cup Specials are SEPARATE from core / moonshot / crown (no blending)", () => {
  ...
  assert.deepEqual(portfolio.record, { wins: 9, losses: 2, voids: 0, pending: 1 }, "core record unchanged by specials (Lane B Step 1 WON)");
  assert.equal(portfolio.openExposure, 100, "core exposure unchanged by specials ($100 — Lane A only)");
