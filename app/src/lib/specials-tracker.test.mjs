...
test("World Cup Specials are SEPARATE from core / moonshot / crown (no blending)", () => {
  ...
  assert.deepEqual(portfolio.record, { wins: 15, losses: 7, voids: 0, pending: 0 }, "core record reflects only the BB settlement, not specials (June-27: both lanes lost their Step → restarted)");
