...
export const MARKET_COVERAGE: readonly MarketCoverage[] = [
  ...
  },
  {
    ...
    requiredData: ["Player-prop odds provider", "lineup/minutes source", "scorer settlement source"],
    settlementSupport: "unsupported",
    publicExplanation: "Not offered — requires a player-prop odds feed plus a settlement source. Never faked.",
  },
  {
    sport: "soccer", market: "shots_shots_on_target", publicLabel: "Shots / shots on target",
    status: "provider_needed", predictionSource: "none",
    requiredData: ["Player-prop odds provider", "shots settlement source"],
    settlementSupport: "unsupported",
    publicExplanation: "Not offered — needs a shots prop feed + settlement. On the roadmap.",
  },
  {
