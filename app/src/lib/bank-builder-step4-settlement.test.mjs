...
test("the Bank Builder final step is framed honestly via the ClimbHero ladder (no invented card)", () => {
  ...
  // honest 'no card reached the price' waiting state, and never fabricates a card to fill the rung.
  ...
  assert.ok(/No card reached this step(’|&rsquo;)s price today/.test(vlad), "an unqualified rung shows an honest pass — no invented card");
