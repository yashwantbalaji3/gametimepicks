...
const THEMES: Record<SimSport, SportSimulationTheme> = {
  ...
  epl: {
    ...
    accentSoft: "color-mix(in srgb, var(--sport-soccer) 20%, transparent)",
  ...
  ufc: {
    ...
    accentSoft: "color-mix(in srgb, var(--sport-ufc) 20%, transparent)",
    label: "UFC",
    poster: "Octagon · red and blue corners",
  },
  nba: {
    scene: "court",
    accent: "var(--vault-info-bright)",
    accentSoft: "color-mix(in srgb, var(--vault-info) 20%, transparent)",
    label: "NBA",
