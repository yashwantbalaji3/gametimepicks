 ...
 *                                      in adapters.test.mjs (NFL-7 bijection, NFL-8 ESPN pairs + by-event-id join). Codes are nflverse's franchise-mapped codes
...
/** Reviewed table: nflverse franchise code → ESPN team id. Proven in adapters.test.mjs (NFL-7 bijection, NFL-8 ESPN pairs + by-event-id join); never extended by guessing. */
