...
test("Mr. Dub: Moonshot exposure is broken out separately and does NOT change the Lane A/B record", () => {
  ...
  // Core Lane A/B record + exposure reflect the July-6 settlement (Lane A WON its cycle-8 Step-1 → record +1 → 18-14;
  // the July-5 losses still stand in the priorLane chain), and Moonshot stays separate from the core record.
  assert.deepEqual(portfolio.record, { wins: 18, losses: 14, voids: 0, pending: 0 }, "core record 18-14 (Lane A won its July-6 cycle-8 Step-1)");
