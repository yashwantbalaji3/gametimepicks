...
test("Mr. Dub: Moonshot exposure is broken out separately and does NOT change the Lane A/B record", () => {
  ...
  // Core Lane A/B record + exposure reflect the June 26 settlement, and Moonshot stays separate from the core record.
  assert.deepEqual(portfolio.record, { wins: 15, losses: 5, voids: 0, pending: 0 }, "core record (June-26: Lane A Step-2 LOST, Lane B Step-1 WON)");
