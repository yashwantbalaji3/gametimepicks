...
test("Lane A Step 1 (Mexico DNB + Soto) was launched from $100 and settled WON → lane active (riding cross-slate Step 3)", () => {
  assert.equal(A.laneStatus, "active", "Lane A active — Steps 1+2 won, Step 3 placed (pending)");
