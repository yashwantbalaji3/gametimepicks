...
const PRIVACY = {
  ...
  sections: [
    ...
    { heading: "What is stored on your device", paragraphs: [
      "To remember your reading preferences, the teams you follow, the picks in your slip, and the forecasts you save, the Site saves small settings in your browser's local storage. A saved forecast is a copy of a forecast card as it read when you saved it; it stays in your browser and is never sent to us. One session value records how you arrived, such as from a shared link.",
