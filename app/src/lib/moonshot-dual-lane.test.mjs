...
test("live June-24 portfolio: both STRUCTURED Moonshot lanes display; paper exposure reconciles; canonical money frozen", () => {
  ...
  assert.equal(dp.activeBankroll, 19265.40, "canonical active bankroll frozen (crown − $1200 twelve real lost seeds, after the July-3 settlement)");
  ...
  assert.deepEqual(p.record, { wins: 17, losses: 12, voids: 0, pending: 0 }, "canonical record untouched by the moonshot view (17-12 after the July-3 BB settlement)");
