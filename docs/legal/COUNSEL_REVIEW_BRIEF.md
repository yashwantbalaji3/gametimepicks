...
- No cookies. Visitor analytics are **on** since 2026-09-10: first-party, cookieless, day-granularity
  counts of a fixed list of interactions, with no IP, device identifier, referrer, or session id stored,
  deleted automatically after 90 days (a daily job).
...
2. `docs/legal/privacy-draft.md` — content hash `cc202ac0977a4e03f57149cbcac944cf1ac3eaa52854cc863fd3eaf6e9251361`
