...
## GLOBAL: no launch_candidate · 2 shadow_watchlist
...
- Segments searched (multiple-comparisons family size): **38** → Bonferroni two-sided z = **3.213** (vs naive 1.960).
...
| `mlb_market_batter_total_bases` | `rejected` | 565 | 41% | 37–45% | 34–47% | 44.0% | -3.3pp | 1.00 | 1/7 |
...
| `mlb_recentform_L5_5of5` | `needs_more_data` | 219 | 63% | 56–69% | 52–73% | 56.5% | +6.5pp | 0.932 | 5/7 |
...
| `mlb_low_gate_5of5_and_-150` | `shadow_watchlist` | 129 | 72% | 64–79% | 58–83% | 62.0% | +10.1pp | 0.332 | 5/7 |
...
| `mlb_line_2_5` | `needs_more_data` | 41 | 54% | 39–68% | 31–75% | 50.1% | +3.5pp | 1.00 | 4/6 |
| `mlb_line_ge3_5` | `market_already_prices_it` | 162 | 49% | 41–56% | 37–61% | 51.4% | -2.7pp | 1.00 | 2/7 |
| `mlb_lowgate_batter_hits` | `shadow_watchlist` | 97 | 74% | 65–82% | 58–86% | 62.8% | +11.5pp | 0.366 | 5/7 |
| `mlb_lowgate_batter_hits_runs_rbis` | `blocked_sample_size` | 23 | 70% | 49–84% | 37–90% | 58.9% | +10.6pp | 1.00 | 5/7 |
| `mlb_lowgate_batter_total_bases` | `blocked_sample_size` | 8 | 63% | 31–86% | 18–92% | 61.6% | +0.9pp | 1.00 | 2/3 |
| `mlb_lowgate_pitcher_strikeouts` | `blocked_sample_size` | 1 | 0% | 0–79% | 0–91% | 56.7% | -56.7pp | 1.00 | 0/1 |
| `mlb_home` | `market_already_prices_it` | 1667 | 50% | 48–53% | 47–54% | 50.5% | -0.0pp | 1.00 | 5/7 |
...
- `mlb_low_gate_5of5_and_-150`: 72% (N=129) vs de-vig 62.0% (edge +10.1pp). Failed gates: corrected_ci, adjusted_p, single_date_overdependence. naive CI 64–79%, corrected 58–83%, p-adj 0.332, dates+ 5/7.
- `mlb_lowgate_batter_hits`: 74% (N=97) vs de-vig 62.8% (edge +11.5pp). Failed gates: corrected_ci, adjusted_p, single_date_overdependence. naive CI 65–82%, corrected 58–86%, p-adj 0.366, dates+ 5/7.
