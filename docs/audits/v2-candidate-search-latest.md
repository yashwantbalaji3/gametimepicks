...
## GLOBAL: no launch_candidate · 1 shadow_watchlist
...
- Segments searched (multiple-comparisons family size): **24** → Bonferroni two-sided z = **3.078** (vs naive 1.960).
...
| `mlb_market_batter_hits` | `market_already_prices_it` | 1317 | 54% | 51–57% | 50–58% | 53.6% | +0.3pp | 1.00 | 3/7 |
| `mlb_market_batter_hits_runs_rbis` | `market_already_prices_it` | 1320 | 51% | 48–53% | 47–55% | 49.5% | +1.3pp | 1.00 | 4/7 |
| `mlb_market_batter_total_bases` | `rejected` | 565 | 41% | 37–45% | 35–47% | 44.0% | -3.3pp | 1.00 | 1/7 |
| `mlb_market_pitcher_strikeouts` | `rejected` | 154 | 47% | 40–55% | 36–60% | 50.8% | -3.4pp | 1.00 | 2/7 |
...
| `mlb_conf_low` | `market_already_prices_it` | 1345 | 51% | 48–54% | 47–55% | 50.5% | +0.6pp | 1.00 | 4/7 |
| `mlb_devig_lt40` | `market_already_prices_it` | 403 | 39% | 34–44% | 32–46% | 36.8% | +1.9pp | 1.00 | 4/7 |
...
| `mlb_devig_ge70` | `blocked_sample_size` | 2 | 100% | 34–100% | 17–100% | 71.5% | +28.5pp | 1.00 | 1/1 |
| `mlb_edge_neg` | `market_already_prices_it` | 717 | 51% | 48–55% | 46–57% | 50.7% | +0.8pp | 1.00 | 5/7 |
...
| `mlb_recentform_L5_5of5` | `needs_more_data` | 219 | 63% | 56–69% | 53–72% | 56.5% | +6.5pp | 0.588 | 5/7 |
| `mlb_recentform_L5_4plus` | `market_already_prices_it` | 954 | 54% | 51–57% | 49–59% | 54.8% | -1.0pp | 1.00 | 3/7 |
| `mlb_recentform_L10_8plus` | `market_already_prices_it` | 464 | 58% | 54–63% | 51–65% | 57.9% | +0.5pp | 1.00 | 3/7 |
| `mlb_low_gate_5of5_and_-150` | `shadow_watchlist` | 129 | 72% | 64–79% | 59–82% | 62.0% | +10.1pp | 0.210 | 5/7 |
| `nba_all_priced_overall` | `market_already_prices_it` | 794 | 53% | 50–56% | 48–58% | 50.3% | +2.7pp | 1.00 | 2/3 |
...
- `mlb_low_gate_5of5_and_-150`: 72% (N=129) vs de-vig 62.0% (edge +10.1pp). Failed gates: corrected_ci, adjusted_p, single_date_overdependence. naive CI 64–79%, corrected 59–82%, p-adj 0.210, dates+ 5/7.
