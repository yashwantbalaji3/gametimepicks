# Parlay Count Consistency — 2026-06-07 (auto-generated)
...
- **DISPLAYED official cards = 15** (after `filterOfficialSuggestedSlips` + `applyVolumeDiscipline`): low 5, medium 5, high 3, longshot 2.
...
- top-bar "64 slips" = generated pool; only 15 official cards displayed (after official filter + volume discipline caps {"low":5,"medium":5,"high":3,"longshot":2} + exposure caps).
